            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="page-title">
                        <h2>Потерялись? Бывает…<span></span> <i class="fa fa-heart-o"></i></h2>
                        <p>
                            К сожалению, этой страницы не оказалось на нашем сайте.
                            Не расстраивайтесь, попробуйте начать с <a href="../index.php">главной страницы<a>.
                        </p>
                    </div>
                </div>
            </div>
