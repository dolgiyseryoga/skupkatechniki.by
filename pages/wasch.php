            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="about-text">
                        ...
                        <p>
                            Даже если ваша стиральная машина вышла из строя и имеет солидные повреждения, это – не повод
                            расстраиваться и выбрасывать ее на свалку, поскольку вы можете сдать стиральную машину и еще получить за нее неплохие
                            деньги! <br>
