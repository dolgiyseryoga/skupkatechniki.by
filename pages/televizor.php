            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="page-title">
                        ...
                        <p>
                            Компания осуществляет скупку старой, сломанной и устаревшей техники на
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="about-text">
                        ...
                        <p>
                            Если ваш телевизор безнадежно сломался
                            или устарел, вы можете решить проблему в самые короткие сроки, воспользовавшись услугами
                            скупки бытовой техники в Витебске и регионах.
                            Если у Вас еще остались вопросы,
                            звоните 7383 и наши специалисты ответят вам на любые оставшиеся
                        ...
                        <ul class="about-list">
                            <li>
                                ...
                                ненужной техники в доме, а получаете за неё хорошие деньги! Наши
                                мастера работают оперативно!
                            </li>
                            <li>
                                <i class="fa fa-check"></i> <strong></strong> уже на следующий день вы сможете
                                купить новое оборудование, которое будет удовлетворять требованиям вашей семьи!
                            </li>
                            <li>
                            ...
                            <li>
                                <i class="fa fa-check"></i>
                                <strong></strong> Честная фиксированная цена за каждый килограмм (в не зависимости от
